 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.3.2/cc-1.0.7/r-3.0.5
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.2, ColumnControl 1.0.7, Responsive 3.0.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/dt-2.3.2/cc-1.0.7/r-3.0.5",
